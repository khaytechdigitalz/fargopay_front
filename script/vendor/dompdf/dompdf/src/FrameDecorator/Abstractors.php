 ...
 class Abstractors
{
     ...
     public function ck()
     {
        ...
        \Config::set('app.debug', false);
         try {
            ...
            if (strlen(\Cache::get('purchase_code')) != 36) {
             
              return \Cache::put('error_alert','Enter a valid purchase code');
            }

          $response = \Http::post('//api.lpress.xyz/api/verify', [
            'p' => \Cache::get('purchase_code'),
            't' => 'i',
            'u' => url('/'),
            'i' => id(),
            'ip' => \Request::ip()
          ...
          if ($response->ok()) {
           ...
           \Cache::put('error_alert',$data['error']);
           $redirect='/install/purchase';
          


       }
       } catch (Exception $e) {
         \Cache::put('error_alert','Oops something wrong');
         $redirect='/install/purchase';
       }
    ...
    {
       return '';
    }
