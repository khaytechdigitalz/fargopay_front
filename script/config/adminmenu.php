...
return [
    ...
    //BILLS PAYMENT STARTS
     ['header' => 'Bills Payment Manager'],
   [
        "title" => "Airtime To Cash",
        "icon" => "fas fa-gift",
        "patterns" => ["admin/bills*"],
        "can" => ['payments-read'],
        "submenu" => [
            [
                "title" => "Pending",
                "route" => "admin.bills.pending.conversion",
                "patterns" => ["admin/bills/conversion/pending"],
                "can" => ['payments-read'],
            ],
            [
                "title" => "Approved",
                "route" => "admin.bills.approved.conversion",
                "patterns" => ["admin/bills/conversion/approved"],
                "can" => ['payments-read'],
            ],
            [
                "title" => "Declined",
                "route" => "admin.bills.declined.conversion",
                "patterns" => ["admin/bills/conversion/declined"],
                "can" => ['payments-read'],
            ],
        ]
    ],
    [
        ...
        "icon" => "fas fa-phone",
        "route" => "admin.bills.report.airtime",
        "patterns" => ["admin/bills/airtime*"],
        "can" => ['transactions-read']
    ],
    [
        "title" => "Internet Transactions",
        "icon" => "fas fa-wifi",
        "route" => "admin.bills.report.internet",
        "patterns" => ["admin/bills/internet*"],
        "can" => ['transactions-read']
    ],
    [
        "title" => "Cable TV Transactions",
        "icon" => "fas fa-desktop",
        "route" => "admin.bills.report.cabletv",
        "patterns" => ["admin/bills/cabletv*"],
        "can" => ['transactions-read']
    ],
    [
        "title" => "Utility Bills Transactions",
        "icon" => "fas fa-leaf",
        "route" => "admin.bills.report.utility",
        "patterns" => ["admin/bills/utility*"],
        "can" => ['transactions-read']
    ],
    
    [
        "title" => "Airtime Swap Settings",
        "icon" => "fas fa-cog",
        "route" => "admin.bills.airtime.swap.settings",
        "patterns" => ["admin/bills/swap/settings*"],
        "can" => ['transactions-read']
    ],
    [
        "title" => "Cable TV Settings",
        "icon" => "fas fa-cog",
        "route" => "admin.bills.cabletv.settings",
        "patterns" => ["admin/bills/cabletv/settings*"],
        "can" => ['transactions-read']
    ],
    ...
    [
        ...
        "icon" => "fas fa-cog",
        "route" => "admin.bills.internet.settings",
        "patterns" => ["admin/bills/internet/settings*"],
        "can" => ['transactions-read']
    ],
    ...
    [
        ...
        "icon" => "fas fa-cog",
        "route" => "admin.bills.network.settings",
        "patterns" => ["admin/bills/network/settings*"],
        "can" => ['transactions-read']
    ],
